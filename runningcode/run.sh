...
# -------------------- PARAMETERS --------------------
MODELS=("Mistral-7B-instruct") # ("deepseek-llm-7b-chat" "Llama-3-8B-instruct""Llama-3-70B-Instruct""Gemma-2-9B-instruct" "Falcon3-7B-instruct"  ,  , , "Falcon3-7B-instruct", "Gemma-2-9B-instruct", )

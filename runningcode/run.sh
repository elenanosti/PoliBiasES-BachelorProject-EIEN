...
# -------------------- PARAMETERS --------------------
MODELS=("deepseek-llm-7b-chat") # ("Mistral-7B-instruct""Falcon3-7B-instruct""Gemma-2-9B-instruct"  "Llama-3-8B-instruct""Llama-3-70B-Instruct"  ,  , , "Falcon3-7B-instruct", "Gemma-2-9B-instruct", )

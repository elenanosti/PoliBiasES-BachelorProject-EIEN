...
# -------------------- PARAMETERS --------------------
MODELS=("Llama-2-7b") # ("Aguila-7B-instruct" "Llama-3-70B-Instruct""Llama-3-8B-instruct" "Gemma-2-9B-instruct" "Falcon3-7B-instruct""Mistral-7B-instruct""deepseek-llm-7b-chat")

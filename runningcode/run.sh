...
# -------------------- PARAMETERS --------------------
MODELS=("Llama-3-70B-Instruct") # ("Mistral-7B-instruct""Gemma-2-9B-instruct""deepseek-llm-7b-chat""Llama-3-8B-instruct" "Falcon3-7B-instruct"  ,  , , "Falcon3-7B-instruct", "Gemma-2-9B-instruct", )
